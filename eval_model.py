...
def init_model(args):
    ...
    if args.load == 0:
        ...
        transformers_model_path = './MiniLLM2'
...
def main():
    ...
    # MiniLLM2-moe (145M)：(hidden_size=640, num_hidden_layers=8, use_moe=True)
    # MiniLLM2-Small (26M)：(hidden_size=512, num_hidden_layers=8)
    # MiniLLM2 (104M)：(hidden_size=768, num_hidden_layers=16)
