...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MiniLLM RLHF")
    ...
    parser.add_argument("--wandb_project", type=str, default="MiniLLM-RLHF-SFT")
    ...
    args.wandb_run_name = f"MiniLLM-Full-DPO-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
