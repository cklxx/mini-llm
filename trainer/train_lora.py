...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MiniLLM SFT with LoRA")
    ...
    parser.add_argument("--wandb_project", type=str, default="MiniLLM-LoRA-SFT")
    ...
    args.wandb_run_name = f"MiniLLM-Lora-SFT-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
